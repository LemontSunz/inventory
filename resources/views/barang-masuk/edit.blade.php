    ...
    <div class="mx-auto w-full max-w-screen-2xl">
        ...
        <form action="{{ route('barang-masuk.update', $incomingGoods->id) }}" method="POST" class="space-y-8 rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <div class="xl:col-span-2 space-y-6">
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" value="{{ $incomingGoods->receiving_code }}" readonly class="w-full rounded-2xl border border-slate-300 bg-slate-100 px-4 py-4 text-slate-900 focus:border-slate-300 focus:outline-none focus:ring-0" />
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('supplier', $incomingGoods->supplier ?? '') }}"
                                required
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="submit" class="group inline-flex items-center justify-center rounded-2xl bg-slate-900 px-6 py-3 font-semibold text-white transition hover:bg-slate-800 cursor-pointer">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
