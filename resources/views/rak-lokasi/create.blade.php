    ...
    <div class="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
        <form action="{{ route('lokasi-rak.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex flex-wrap gap-3">
                <button type="submit" class="group inline-flex items-center justify-center rounded-3xl bg-slate-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 cursor-pointer">Simpan Lokasi</button>
