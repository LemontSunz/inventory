<aside id="sidebar" class="sidebar sticky top-20 z-40 w-20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 shadow-2xl transition-all duration-300 md:w-64">
    ...
    <nav class="flex-1 space-y-4 overflow-y-auto px-2 py-6 md:px-4">
        ...
        <div class="space-y-2">
            ...
            <a href="{{ route('dashboard') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 text-slate-300 transition duration-200 {{ request()->routeIs('dashboard') ? 'bg-purple-700 text-white shadow-xl' : 'hover:bg-purple-700 hover:text-white' }} cursor-pointer">
        ...
        <div class="space-y-2">
            @if(auth()->user()->role === 'manager')
                ...
                <a href="{{ route('barang.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ request()->routeIs('barang.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Data Barang">
                ...
                <a href="{{ route('cabang.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ request()->routeIs('cabang.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Data Cabang">
                ...
                <a href="{{ route('lokasi-rak.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ request()->routeIs('lokasi-rak.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-purple-700 hover:text-white group cursor-pointer" title="Lokasi Rak">
                ...
                <a href="{{ route('barang-masuk.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ request()->routeIs('barang-masuk.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Laporan Barang Masuk">
                ...
                <a href="{{ route('warehouse.outbound.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ request()->routeIs('warehouse.outbound.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Laporan Barang Keluar">
                ...
                <a href="{{ route('warehouse.stock.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ $stockActive }} transition duration-200 hover:bg-purple-700 hover:text-white group cursor-pointer" title="Laporan Stok Barang">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-purple-500/20 text-purple-400 group-hover:bg-purple-500 group-hover:text-white">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('users.index') }}" class="sidebar-item flex items-center gap-4 rounded-3xl px-3 py-3 {{ request()->routeIs('users.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-purple-700 hover:text-white group cursor-pointer" title="Kelola Pengguna">
            ...
            @else
                ...
                <!-- Kelola Data Barang -->
                <a href="{{ route('barang.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 {{ request()->routeIs('barang.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Kelola Data Barang">
                ...
                <!-- Data Cabang -->
                <a href="{{ route('cabang.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 {{ request()->routeIs('cabang.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Data Cabang">
                ...
                <a href="{{ route('barang-masuk.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 {{ request()->routeIs('barang-masuk.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Kelola Barang Masuk">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-blue-500/20 text-blue-400 group-hover:bg-blue-500 group-hover:text-white">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                ...
                <a href="{{ route('warehouse.outbound.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 {{ request()->routeIs('warehouse.outbound.*') ? 'bg-purple-700 text-white shadow-xl' : 'text-slate-300' }} transition duration-200 hover:bg-slate-700 hover:text-white group cursor-pointer" title="Kelola Barang Keluar">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-orange-500/20 text-orange-400 group-hover:bg-orange-500 group-hover:text-white">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                        </svg>
                ...
                <a href="{{ route('lokasi-rak.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 {{ request()->routeIs('lokasi-rak.*') ? 'bg-purple-700 text-white' : 'text-slate-300' }} transition duration-200 hover:bg-purple-700 hover:text-white group cursor-pointer" title="Lokasi Rak">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-purple-500/20 text-purple-400 group-hover:bg-purple-500 group-hover:text-white">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                ...
                @php $stockActive = request()->routeIs('warehouse.stock.*') ? 'bg-purple-700 text-white' : 'text-slate-300'; @endphp
                <a href="{{ route('warehouse.stock.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 {{ $stockActive }} transition duration-200 hover:bg-purple-700 hover:text-white group cursor-pointer" title="Laporan Stok Barang">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded bg-purple-500/20 text-purple-400 group-hover:bg-purple-500 group-hover:text-white">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                ...
                <!-- Armada -->
                <a href="{{ route('armada.drivers.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 text-slate-300 transition duration-200 {{ request()->routeIs('armada.drivers.*') ? 'bg-purple-700 text-white shadow-xl' : 'hover:bg-purple-700 hover:text-white' }} cursor-pointer" title="Armada Driver">
                ...
                <!-- Kendaraan -->
                <a href="{{ route('kendaraan.index') }}" class="sidebar-item flex items-center gap-4 rounded-lg px-3 py-3 text-slate-300 transition duration-200 {{ request()->routeIs('kendaraan.*') ? 'bg-purple-700 text-white shadow-xl' : 'hover:bg-purple-700 hover:text-white' }} cursor-pointer" title="Kelola Kendaraan">
