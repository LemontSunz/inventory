...
@section('title', 'Edit Cabang - LogistikPro')
...
<div class="mx-auto max-w-2xl">
    ...
    <!-- Header -->
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-gray-900">Edit Data Cabang</h2>
        <p class="mt-2 text-gray-600">Perbarui informasi cabang: <span class="font-semibold">{{ $cabang->nama_cabang }}</span></p>
    </div>
    ...
    <div class="rounded-xl bg-white shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form action="{{ route('cabang.update', $cabang->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="kode_cabang" name="kode_cabang" value="{{ old('kode_cabang', $cabang->kode_cabang) }}" placeholder="Contoh: CB-001"
            ...
            <div>
                ...
                <input type="text" id="nama_cabang" name="nama_cabang" value="{{ old('nama_cabang', $cabang->nama_cabang) }}" placeholder="Masukkan nama cabang"
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="kota" name="kota" value="{{ old('kota', $cabang->kota) }}" placeholder="Contoh: Jakarta"
                ...
                <div class="sm:col-span-1">
                    ...
                    <input type="text" id="alamat" name="alamat" value="{{ old('alamat', $cabang->alamat) }}" placeholder="Masukkan alamat cabang"
